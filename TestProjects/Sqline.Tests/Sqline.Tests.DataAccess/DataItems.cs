...
namespace Sqline.Tests.DataAccess.SqlServer.DataItems {
	...
	public class TypeTestInsert : InsertDataItem {
		...
		public TypeTestInsert() {
			Initialize("dbo", "TypeTest", Sqline.Tests.DataAccess.SqlServer.DAHandler.SqlineApplication);
...
AddParameter(FWhereXmlColumn, "XmlColumn");
	...
	public class TestInsert : InsertDataItem {
		...
		public TestInsert(ValueParam<bool> processed) {
			Initialize("dbo", "Test", Sqline.Tests.DataAccess.SqlServer.DAHandler.SqlineApplication);
